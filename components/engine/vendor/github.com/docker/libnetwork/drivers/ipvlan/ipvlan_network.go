...
func (d *driver) createNetwork(config *configuration) error {
	...
	for _, nw := range networkList {
		// eyz START: cleanup duplicate ipvlan and macvlan network IDs during createNetwork (https://github.com/docker/libnetwork/pull/2055)
		...
		// eyz STOP: cleanup duplicate ipvlan and macvlan network IDs during createNetwork (https://github.com/docker/libnetwork/pull/2055)
	}
